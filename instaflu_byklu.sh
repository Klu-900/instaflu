...
echo -e "\e[1;91m ═╩═\e[1;92m         \e[1;91m╩   by - \e[1;92m UPDATE BY : [ KLU SCRIPTER ] INSPIRED BY : TERMUX PROFFECER "
...
selena="KLU_SCRIPT_BOTTING[ -_- ]"
neymar="KLU_SCRIPT_BOTTING[ -_- ]"
ariana="KLU_SCRIPT_BOTTING[ -_- ]"
beyonce="KLU_SCRIPT_BOTTING[ -_- ]"
cristiano="KLU_SCRIPT_BOTTING[ -_- ]"
kimkardashian="KLU_SCRIPT_BOTTING[ -_- ]"
kendall="KLU_SCRIPT_BOTTING[ -_- ]"
therock="KLU_SCRIPT_BOTTING[ -_- ]"
kylie="KLU_SCRIPT_BOTTING[ -_- ]"
jelopez="KLU_SCRIPT_BOTTING[ -_- ]"
messi="KLU_SCRIPT_BOTTING[ -_- ]"
professor="KLU_SCRIPT_BOTTING[ -_- ]"
dualipa="KLU_SCRIPT_BOTTING[ -_- ]"
celebrity="KLU_SCRIPT_BOTTING[ -_- ]"
mileycyrus="KLU_SCRIPT_BOTTING[ -_- ]"
shawnmendes="KLU_SCRIPT_BOTTING[ -_- ]"
katyperry="KLU_SCRIPT_BOTTING[ -_- ]"
charlieputh="KLU_SCRIPT_BOTTING[ -_- ]"
lelepons="KLU_SCRIPT_BOTTING[ -_- ]"
camila_cabello="KLU_SCRIPT_BOTTING[ -_- ]"
madonna="KLU_SCRIPT_BOTTING[ -_- ]"
leonardodicaprio="KLU_SCRIPT_BOTTING[ -_- ]"
ladygaga="KLU_SCRIPT_BOTTING[ -_- ]"
taylorswift="KLU_SCRIPT_BOTTING[ -_- ]"
instagram="KLU_SCRIPT_BOTTING[ -_- ]"
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m SUBSCRIBE K_L_U MODDING [ FOR MORE ] %s ..." $celeb
...
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m [ NO SLEEPING ]...\e[0m\n"
#sleep 60
#unfollow
for celeb in $(cat celeb_id); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf " \e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Trying to unfollow  %s ..." $celeb
